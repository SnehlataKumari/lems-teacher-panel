...
export class MyChatAdapter extends ChatAdapter {
  ...
  sendMessage(message: Message): void {
    setTimeout(() => {
      ...
      if (isNaN(message.toId)) {
        let group = MyChatAdapter.mockedParticipants.find(
          (x) => x.id == message.toId
        ) as Group;
  ...
  groupCreated(group: Group): void {
    MyChatAdapter.mockedParticipants.push(group);

    MyChatAdapter.mockedParticipants = MyChatAdapter.mockedParticipants.sort(
